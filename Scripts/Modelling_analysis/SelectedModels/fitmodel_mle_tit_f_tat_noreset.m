function [estimates, model, fval, exitflag, v_vec] = fitmodel_mle_tit_f_tat_noreset(trustee, ydata,condition, prior) % xdata1 is outcome, xdat2 is for resetting
...
%                     v_vec(i,1) = trustee(i-1,1)*ydata(i-1,1);
                ...
                elseif ydata(i-1,1) == 0
                    ...
                    % exceed 1.
                    % scheme.
                    delta_decay = 5-v_vec(i-1,1); % here "1" instead of "xdata1(i,1)" 
