function [estimates, model, fval, exitflag, v_vec, delta] = fitmodel_mle_rl_BIN_bound_onepar(trustee, reset_sub, ydata, condition, prior) % trustee is outcome, xdat2 is for resetting
