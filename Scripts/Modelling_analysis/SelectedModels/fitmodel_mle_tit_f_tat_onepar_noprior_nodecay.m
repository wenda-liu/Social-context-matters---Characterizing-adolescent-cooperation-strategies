function [estimates, model, fval, exitflag, v_vec] = fitmodel_mle_tit_f_tat_onepar_noprior_nodecay(trustee, reset_sub, ydata) % xdata1 is outcome, xdat2 is for resetting
