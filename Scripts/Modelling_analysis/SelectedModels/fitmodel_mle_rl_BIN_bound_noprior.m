function [estimates, model, fval, exitflag, v_vec, delta] = fitmodel_mle_rl_BIN_bound_noprior(trustee, reset_sub, ydata, condition) % trustee is outcome, xdat2 is for resetting
        ...
        for i = 1:length(trustee)
            if reset_sub(i,1) == 1
                ...
                if ydata(i-1,1) > 0 %if person shares just do your rl
                    ...
                    switch condition(i,1) <=2%3nonsocial 4 social
                        case 1 
