function [estimates, model, fval, exitflag, v_vec] = fitmodel_mle_tit_f_tat_onepar_nodecay(trustee, reset_sub, ydata,condition, prior) % xdata1 is outcome, xdat2 is for resetting
