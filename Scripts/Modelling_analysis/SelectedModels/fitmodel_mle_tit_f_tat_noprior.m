function [estimates, model, fval, exitflag, v_vec] = fitmodel_mle_tit_f_tat_noprior(trustee, reset_sub, ydata,condition) % xdata1 is outcome, xdat2 is for resetting
